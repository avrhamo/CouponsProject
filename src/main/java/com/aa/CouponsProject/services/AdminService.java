...
public interface AdminService {
    ...
    //Customer CRUD
    void addCustomer(Customer customer) throws CouponSystemCustomExceptions;
    void updateCustomer(int customerId, Customer customer) throws CouponSystemCustomExceptions;
